          ...
          <>
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-indigo-500  shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "hover:border-indigo-600 shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }`}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-indigo-500 hover:bg-indigo-700 text-black"
